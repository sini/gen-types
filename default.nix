...
# rule. Both dependencies are root inputs of the ci lock, so every path below is one segment.
#
...
# eager body a WHNF force of the root reaches both, whatever the published surface's shape.
#
